  ...
  return (
    <section className="w-full bg-paper py-24 border-t border-ink/5">
      <div className="container mx-auto px-4 md:px-8 max-w-5xl text-center">
        <ScrollReveal>
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-ink mb-16">Take P1NTO Home.</h2>
        </ScrollReveal>
          ...
          {[1, 2, 3].map((item) => (
            <Link href="/coffee" key={item} className="group block">
              <div className="relative aspect-square w-full mb-6 overflow-hidden rounded-sm bg-ink/5">
                <Image src={`https://images.unsplash.com/photo-${item === 1 ? '1559525839-b184a4d698c7' : item === 2 ? '1587734195503-904fca47e0e9' : '1620189507195-68309c04c4d0'}?q=80&w=600&auto=format&fit=crop`} alt="Coffee Bag" fill className="object-cover group-hover:scale-105 transition-transform duration-1000" />
              </div>
