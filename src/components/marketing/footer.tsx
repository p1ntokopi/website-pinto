...
export function Footer() {
  return (
    <footer className="bg-ink text-paper py-12">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="col-span-1 md:col-span-2">
          <Link href="/" className="flex items-center gap-2 mb-4">
            ...
            <span className="font-display text-2xl font-bold text-cream">P1NTO</span>
          </Link>
          <p className="text-muted-foreground max-w-sm leading-relaxed">
            Experience the perfect blend of tradition and modernity. 
            Crafting the finest coffee to fuel your day, right from your table.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link href="#menu" className="text-muted-foreground hover:text-white transition-colors text-sm">Our Menu</Link></li>
        ...
        <div>
          <h3 className="font-semibold text-lg mb-4 text-cream">Connect</h3>
      ...
      <div className="container mx-auto px-4 mt-12 pt-8 border-t border-border-custom/20 text-center text-sm text-muted-foreground">
        © {new Date().getFullYear()} P1NTO Coffee. All rights reserved.
      </div>
    </footer>
  );
}
