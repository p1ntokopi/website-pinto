...
- Name: cashier-session.spec.ts >> cashier-first POS (Pesanan Baru) >> marks occupied tables and requires an explicit join
- Location: tests\e2e\cashier-session.spec.ts:80:7
