...
- Name: cashier-session.spec.ts >> cashier-first POS (Pesanan Baru) >> builds a DINE-IN order through the review and confirmation step
- Location: tests\e2e\cashier-session.spec.ts:37:7
